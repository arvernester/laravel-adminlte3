...
<div class="container-fluid">
  ...
  <!-- =========================================================== -->
  <h5 class="mt-4 mb-2">Info Box With
    <code>bg-*</code>
  </h5>
  <div class="row">
    <div class="col-md-3 col-sm-6 col-12">
        ...
        <div class="card-body">
          ...
          <div class="direct-chat-contacts">
            <ul class="contacts-list">
              <li>
                <a href="#">
                  <img class="contacts-list-img" src="http://via.placeholder.com/128x128">
  ...
  <div class="row">
      ...
      <div class="card card-widget widget-user-2">
        ...
        <div class="widget-user-header bg-warning">
          <div class="widget-user-image">
            <img class="img-circle elevation-2" src="http://via.placeholder.com/128x128" alt="User Avatar">
          </div>
          <!-- /.widget-user-image -->
    ...
    <div class="col-md-4">
      ...
      <div class="card card-widget widget-user">
        <!-- Add the bg color to the header using any of the bg-* classes -->
        <div class="widget-user-header text-white" style="background: url('http://via.placeholder.com/128x128') center center;">
      ...
      <div class="card card-widget">
        <div class="card-header">
          <div class="user-block">
            <img class="img-circle" src="http://via.placeholder.com/128x128" alt="User Image">
            <span class="username">
        ...
        <!-- /.card-header -->
        <div class="card-body">
          <img class="img-fluid pad" src="http://via.placeholder.com/128x128" alt="Photo">
        ...
        <div class="card-footer card-comments">
          <div class="card-comment">
            <!-- User image -->
            <img class="img-circle img-sm" src="http://via.placeholder.com/128x128" alt="User Image">
        ...
        <div class="card-footer">
          <form action="#" method="post">
            <img class="img-fluid img-circle img-sm" src="http://via.placeholder.com/128x128" alt="Alt Text">
    ...
    <div class="col-md-6">
      ...
      <div class="card card-widget">
        ...
        <div class="card-body">
          ...
          <p>the coast of the Semantics, a large language ocean. A small river named Duden flows by their place and supplies
            it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into
            your mouth.</p>

          <!-- Attachment -->
          <div class="attachment-block clearfix">
            <img class="attachment-img" src="http://via.placeholder.com/128x128" alt="Attachment Image">
