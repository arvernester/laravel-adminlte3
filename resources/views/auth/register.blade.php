    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body term-body">
                <h1>Terms and Conditions for <span class="highlight preview_company_name">"{{ config('app.name') }}"</span></h1>
                ...
                <a href="https://termsandcondiitionssample.com">These terms and conditions have been generated at Terms And Conditions Sample.com</a><p></p>
        </div>
