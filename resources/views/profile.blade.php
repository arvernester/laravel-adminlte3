  ...
  <div class="row">
    <div class="col-md-3">
      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
          <strong>
            <i class="fa fa-book mr-1"></i> Education</strong>
          ...
          <strong>
            <i class="fa fa-map-marker mr-1"></i> Location</strong>
          ...
          <strong>
            <i class="fa fa-pencil mr-1"></i> Skills</strong>
          ...
          <strong>
            <i class="fa fa-file-text-o mr-1"></i> Notes</strong>
            ...
            <div class="active tab-pane" id="activity">
              ...
              <div class="post">
                <div class="user-block">
                  <img class="img-circle img-bordered-sm" src="http://via.placeholder.com/128x128" alt="user image">
                  <span class="username">
                ...
                <p>
                  ...
                  its demise, but others ignore the hate as they create awesome tools to help create filler text for everyone
                  from bacon lovers to Charlie Sheen fans.
                </p>

                <p>
                  <a href="#" class="link-black text-sm mr-2">
                    <i class="fa fa-share mr-1"></i> Share</a>
                  <a href="#" class="link-black text-sm">
                    <i class="fa fa-thumbs-o-up mr-1"></i> Like</a>
              ...
              <div class="post">
                ...
                <div class="row mb-3">
                  <div class="col-sm-6">
                    <img class="img-fluid" src="http://via.placeholder.com/128x128" alt="Photo">
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-6">
                    <div class="row">
                      <div class="col-sm-6">
                        <img class="img-fluid mb-3" src="http://via.placeholder.com/128x128" alt="Photo">
                        <img class="img-fluid" src="http://via.placeholder.com/128x128" alt="Photo">
                      </div>
                      <!-- /.col -->
                      <div class="col-sm-6">
